...
public class VehiculesClientItemsAdapter extends BaseAdapter {

    private Context context;
    private List<VehiculeClient> vehiculesClientList;
    private LayoutInflater inflater;

    public VehiculesClientItemsAdapter(Context context, List<VehiculeClient> vehiculesClientList) {
